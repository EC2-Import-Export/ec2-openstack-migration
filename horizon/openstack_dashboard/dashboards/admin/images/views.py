...
from openstack_dashboard.dashboards.admin.images.forms \
    import AdminExportImageForm
from openstack_dashboard.dashboards.admin.images.forms \
    import AdminImportImageForm
...
class ExportView(views.ExportView):
    template_name = 'admin/images/export.html'
    form_class = AdminExportImageForm
    success_url = reverse_lazy('horizon:admin:images:index')

class ImportView(views.ImportView):
    template_name = 'admin/images/import.html'
