...
from openstack_dashboard.dashboards.project.images_and_snapshots \
        .images.tables import ExportImage
from openstack_dashboard.dashboards.project.images_and_snapshots \
        .images.tables import ImportImage
from openstack_dashboard.dashboards.project.images_and_snapshots \
...
class AdminExportImage(ExportImage):
    url = "horizon:admin:images:export"


class AdminImportImage(ImportImage):
    url = "horizon:admin:images:import"
...
class AdminImagesTable(ImagesTable):
    ...
    class Meta:
        ...
        table_actions = (AdminCreateImage, AdminExportImage, AdminImportImage,  AdminDeleteImage,)
