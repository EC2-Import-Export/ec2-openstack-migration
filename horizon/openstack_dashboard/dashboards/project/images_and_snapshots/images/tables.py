...
class ImportImage(tables.LinkAction):
    name = "import"
    verbose_name = _("Import Image")
    url = "horizon:project:images_and_snapshots:images:import"
    classes = ("ajax-modal", "btn-import")


class ExportImage(tables.LinkAction):
    name = "export"
    verbose_name = _("Export")
    url = "horizon:project:images_and_snapshots:images:export"
    classes = ("ajax-modal", "btn-Export")
...
class ImagesTable(tables.DataTable):
    ...
    class Meta:
        ...
        table_actions = (OwnerFilter, ImportImage, CreateImage, DeleteImage,)
